...
<head>
    ...
    <link
        ...
        />
    <link rel="stylesheet" type="text/css" href="/InventarioAuditores/Assets/css/loading.css">
...
<template>
  <div>
    ...
    >
      <form ref="form" @submit.stop.prevent="handleSubmit">
        ...
        <header>
            <table>
                <tr>
                    <td><img src="/InventarioAuditores/Assets/images/logo.png" alt=""></td>
                ...
                <div class="row">
                    <div class="col-md-6 offset-md-3">
                        <div class="form-group">
                            ...
                            <select name="auditor" id="auditor" class="form-control" v-model="auditor">
                                <option value="-1">Selecciona auditor</option>
                                <option value="C.P. Felipe Rosales Rosales">C.P. Felipe Rosales Rosales</option>
                                <option value="C.P. Feliciano Coutino de la Torre">C.P. Feliciano Coutino de la Torre</option>
                                <option value="C.P. Guadalupe de Jesús Ralda Bautista">C.P. Guadalupe de Jesús Ralda Bautista</option>
                            </select>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 offset-md-3">
                        <div class="form-group">
                                ...
                                <select class="form-control" v-model="sucursal" >
                                    ...
                                    <!-- <option :value="748">MATRIX</option>
                                    <option :value="10756">MATRIX 5A</option>
                                    <option :value="10757">MATRIX PALMERAS</option> -->
                                </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <table class=" table table-striped" id="listado">
                        ...
                        <tfoot>
                            ...
                            <td v-show="tipoInventario == 5"><button type="button" class="btn btn-success" @click="guardaInventarioConComentarios" v-show="confirmar" >Confirmar Inventario con Comentarios</button></td>
                            </tr>
                        </tfoot>
    ...
    <script src="/InventarioAuditores/Assets/js/vue.min.js"></script>
    <script src="https://unpkg.com/bootstrap-vue@latest/dist/bootstrap-vue.js"></script>
    
    <script src="https://cdnjs.cloudflare.com/ajax/libs/axios/0.18.0/axios.js"></script>
    <script src="/InventarioAuditores/Assets/js/index.js"></script>
    
    <script src="/InventarioAuditores/Assets/js/components/option-select.js"></script>
</body>
</html>