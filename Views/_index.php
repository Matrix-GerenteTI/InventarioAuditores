...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/InventarioAuditores/Assets/css/bootstrap.min.css">
...
<body>
    ...
    <div class="container" id="dashboard">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="form-group">
                                ...
                                <select class="form-control" v-model="sucursal">
                                    ...
                                    <option v-for="sucursal in sucursales"  :value="sucursal.idprediction">{{sucursal.descripcion}}</option>
                                </select>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" v-model="tipoInventario">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" v-model="familia">
                                <option value="-1">Selecciona Famailia</option>
                ...
                <table class=" table table-striped" id="listado">
                    ...
                    <tfoot>
                        <tr>
                         ...
                         <td><button type="button" class="btn btn-success" @click="guardaInventario">Confirmar Inventario</button></td>
                        </tr>
                    </tfoot>
        ...
        <script src="/InventarioAuditores/Assets/js/jquery-1.11.2.min.js"></script>
