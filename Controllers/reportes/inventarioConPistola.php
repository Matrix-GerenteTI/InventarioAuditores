...
class InventarioConPistola extends PrepareExcel
{
    ...
    public function generarReporte( $mes , $anio)
    {
        ...
        $reporteTerminado->setIncludeCharts(TRUE);
         $reporteTerminado->save($_SERVER['DOCUMENT_ROOT']."/InventarioAuditores/controllers/reportes/inventarioConPistola.xlsx");
        $ubicacion = "http://servermatrixxxb.ddns.net:8181/InventarioAuditores/controllers/reportes/inventarioConPistola.xlsx";
