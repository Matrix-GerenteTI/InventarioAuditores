...
class ReporteInventario extends PrepareExcel 
{
    ...
    public function generaReporte ()
    {
        ...
        foreach ($sucursales as $index => $sucursal) {
            ...
            $newDate = $originalDate;//$DateTime->format('Y-m-d');
            $inventario = $inventarios->getInventariosSucursal( array('sucursal' => $sucursal->ID, 'fecha' => $newDate));        
            ...
            if ( sizeof($inventario)) {
                ...
                $this->libro->getActiveSheet()->setCellValue("A5", "INVENTARIO $tipoInventario REALIZADO EL ".$newDate);
                ...
                $this->libro->getActivesheet()->setCellValue("N8", "REALIZADO POR:");
                ...
                foreach ($inventario as $idx => $producto) {
                    ...
                    $this->libro->getActiveSheet()->setCellValue("N$i", utf8_decode($producto['auditor']));
                ...
                $this->libro->getActiveSheet()->getStyle("A8:N".($i-1))->applyFromArray($this->bordes);
        ...
        $reporteTerminado->save("reporteInventariosAuditores.xlsx");
    }
}
...
$configCorreo = array("descripcionDestinatario" => "Reporte de Inventarios Auditores",
                                       "mensaje" => "...",
                                       "pathFile" => "reporteInventariosAuditores.xlsx",
