    ...
    methods: {
        ...
        run_clock: function(id, endtime) {
            ...
            function update_clock() {
                ...
                clock.innerHTML = 'Restante<br> ' + t.hours + ':' + t.minutes + ': ' + t.seconds;
                _this.transcurrido++;
        ...
        showInventario: function() {
            let _this = this;
            console.log(_this);
            console.log('Auditor:' + _this.auditor);
            ...
            axios.get("/InventarioAuditores/Controllers/inventarios.php", { // se ejecuta al dar clic en el boton de cntinuar del login
                params: {
                ...
                if (tipoDeInventario != 'general' && tipoDeInventario != 'herramienta') {
                    ...
                    this.deadline = new Date(this.current_time + 180 * 60 * 1000)
                            ...
                            if (localStorage.sucursal == this.sucursal) {
                                ...
                                if (localStorage.familia == this.familia) {
                                    ...
                                    if (localStorage.tipo == this.tipoInventario) {
                                        ...
                                        localStorage.setItem('auditor', this.auditor);
                                    }
                                } else {
                                    this.inventario = result.data;
                                    localStorage.setItem("inventario", JSON.stringify(this.inventario));
        ...
        cargaSucursales: function() {
            axios.get('/InventarioAuditores/Controllers/inventarios.php', { //carga en el login
                params: {
                    opc: 'sucursales'
                }
            }).then((response) => {
        ...
        cargaSubfamilias: function() {
            axios.get("/InventarioAuditores/Controllers/inventarios.php", {
                params: {
                    opc: 'subfamilias',
                    tipoinventario: this.tipoInventario,
                    familia: this.familia,
...
console.log('guardaInventarioConComentarios')
        ...
        agregaManual: function() {
            ...
            axios.post('/InventarioAuditores/Controllers/inventarios.php', {
        ...
        enviaReporte: function() {
            ...
            if (confirmEnvio == true) {
                this.loading = !this.loading;
                axios.get("/InventarioAuditores/Controllers/reporteInventario.php").then((result) => {
    ...
    watch: {
        ...
        sucursal: function(newSucursalSelected) {
            axios.get('/InventarioAuditores/Controllers/inventarios.php', { //carga cuando se escoje la sucursal en el login
                params: {
                    sucursal: this.sucursal,
                    opc: 'getProgramado'
                }
