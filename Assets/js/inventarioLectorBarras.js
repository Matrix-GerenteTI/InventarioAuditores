    ...
    methods: {
        checaSesion: function() {
            axios.get("/InventarioAuditores/Controllers/inventarios.php", {
                ...
                if (result.data == 0) {
                    document.location.href = "http://servermatrixxxb.ddns.net:8181/InventarioAuditores/inventario.php?closeSession";
                }
            }).catch((err) => {
        ...
        getUsuario: function() {
            console.log("Entra")
            axios.get("/InventarioAuditores/Controllers/inventarios2.php", {
                params: {
                    opc: 'getUser'
                }
            }).then((result) => {
        ...
        guardar: function() {
            ...
            axios.post("/InventarioAuditores/Controllers/inventarios2.php", {
                action: "codBarras",
                tipo: 4,
...
function closeSession() {
    window.open("http://servermatrixxxb.ddns.net:8181/InventarioAuditores/inventario.php?closeSession")
}